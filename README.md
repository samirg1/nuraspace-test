...
- After selecting a city, display the current weather for that location (using any
free weather API).
3. Live Messages
- Implement real-time popups to display messages.
- Use WebSockets (or an equivalent real-time solution) to deliver these
messages.
- Provide a mechanism to push messages into the system (e.g., an endpoint
